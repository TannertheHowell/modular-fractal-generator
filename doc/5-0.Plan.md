...
For this phase of the assignment less code was written and more work was done chopping up the three starter files into
their modular versions in 6 different files instead. 
